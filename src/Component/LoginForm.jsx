        ...
        <>
            ...
            <div className="bg-gray-800">
                <div className="h-16 px-8 flex items-center">
                    <p className="text-white font-bold">Resource Requirement <span className='text-red-500'>Login</span></p>
                </div>
            </div>
            <div className="mx-auto max-w-2xl max-h-80 h-80 shadow rounded">
